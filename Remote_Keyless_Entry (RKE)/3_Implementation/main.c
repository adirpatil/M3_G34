 ...
 * @return flag
 */
int encrypt() // Function used for encryption
...
/**
 * @brief Here all the LEDs are on when the the lock operation is called
 *
 */
void lock(void) // LEDs = 1
{
...
/**
 * @brief Here the LEDs are turned on in clock wise order
 *
 */
...
/**
 * @brief Here the LEDs are turned on in anti-clockwise sequence
 *
 */
